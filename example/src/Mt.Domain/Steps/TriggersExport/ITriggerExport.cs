...
/// outcome the step retries (spec 11), not a failure. The adapter translates the migration id
...
public interface ITriggerExport
{
    ...
    public abstract record Response
    {
        ...
        /// <summary>Source did not start the export this time; the step decides whether to retry.</summary>
