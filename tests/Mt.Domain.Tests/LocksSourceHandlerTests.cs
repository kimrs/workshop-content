...
using Handler = Mt.Domain.Stages.LocksSource.Handler;
using IFetchMigration = Mt.Domain.Stages.LocksSource.IFetchMigration;
using LockResponse = Mt.Domain.Stages.LocksSource.ILockSource.Response;
using Response = Mt.Domain.Stages.LocksSource.IFetchMigration.Response;
using SetResponse = Mt.Domain.Stages.LocksSource.ISetSourceLocked.Response;
