...
/// <summary>
/// Fetch the migration as this stage sees it (specs 4/5): the <see cref="PreSaftUploaded"/>
/// state to work on, <see cref="Response.DoNotProceed"/> when the migration was cancelled, or
...
public interface IFetchMigration
{
    ...
    public abstract record Response
    {
        ...
        public sealed record Proceed(PreSaftUploaded Migration) : Response;
