...
/// Shared across the step handlers — these are constants, not the slice logic that §4.3 keeps
...
{
    public const int StepSkippedCancelled = 1001;

    public const int StepAlreadyDone = 1002;

    public const int StepRetryScheduled = 1003;

    public const int StepOutOfRetries = 1004;
